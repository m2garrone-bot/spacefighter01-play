import{c as e}from"./index-DfxcIkvT.js";const o="decalFragmentDeclaration",u=`#ifdef DECAL
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=g);const l="shadowsFragmentFunctions",D=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=D);const c="samplerFragmentDeclaration",C=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=C);const n="reflectionFunction",E=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=E);const v="imageProcessingDeclaration",x=`#ifdef EXPOSURE
