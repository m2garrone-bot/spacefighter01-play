import{c as e}from"./index-BS9wxgRW.js";import"./oitFragment-DiP9q5dk.js";import"./openpbrUboDeclaration-DLO6j7rt.js";import"./pbrDebug-DtcRWH6m.js";import"./logDepthDeclaration-DdJDvbIK.js";import"./fogFragment-D8Spdeit.js";import"./helperFunctions-CDPdibEw.js";import"./harmonicsFunctions-BhPPrvG0.js";import"./meshUboDeclaration-DGZn1Nx0.js";import"./mainUVVaryingDeclaration-CMlL_2FY.js";const i="openpbrFragmentDeclaration",R=`uniform vec4 vEyePosition;uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform vec2 vGeometryCoatTangent;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform vec4 vLightingIntensity;uniform float visibility;
#ifdef BASE_COLOR
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=R);const n="openpbrFragmentSamplersDeclaration",h=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=h);const a="openpbrNormalMapFragmentMainFunctions",N=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=N);const t="openpbrNormalMapFragmentFunctions",A=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=A);const r="openpbrDielectricReflectance",S=`struct ReflectanceParams
...
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=S);const l="openpbrConductorReflectance",T=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=T);const c="openpbrBlockAmbientOcclusion",L=`struct ambientOcclusionOutParams
...
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=L);const f="openpbrGeometryInfo",O=`struct geometryInfoOutParams
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=O);const s="openpbrIblFunctions",F=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=F);const d="openpbrNormalMapFragment",C=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=C);const m="openpbrBlockNormalFinal",b=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=b);const u="openpbrBaseLayerData",D=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=D);const _="openpbrCoatLayerData",M=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=M);const g="openpbrThinFilmLayerData",P=`#ifdef THIN_FILM
...
#endif
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=P);const p="openpbrEnvironmentLighting",G=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=G);const I="openpbrDirectLightingInit",x=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=x);const E="openpbrDirectLighting",y=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=y);const o="openpbrPixelShader",v=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[o]||(e.ShadersStore[o]=v);const $={name:o,shader:v};export{$ as openpbrPixelShader};
