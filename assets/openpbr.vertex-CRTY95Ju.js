import{c as e}from"./index-BS9wxgRW.js";import"./openpbrUboDeclaration-BnmviTIL.js";import"./vertexColorMixing-BeKEY_kp.js";import"./mainUVVaryingDeclaration-X84wF04a.js";import"./helperFunctions-aHUsQVqd.js";import"./harmonicsFunctions-BWmQr5Fd.js";import"./bakedVertexAnimation-CPwru-HK.js";import"./instancesDeclaration-BZDhepAQ.js";import"./clipPlaneVertex-D5mV9oxS.js";import"./logDepthVertex-DtEifb3T.js";import"./logDepthDeclaration-CkJKbonn.js";import"./meshUboDeclaration-B9BH-mM5.js";const t="openpbrNormalMapVertexDeclaration",o=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=o);const i="openpbrNormalMapVertex",a=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=a);const n="openpbrVertexShader",r=`#define OPENPBR_VERTEX_SHADER
