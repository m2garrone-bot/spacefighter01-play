import{c as e}from"./index-BS9wxgRW.js";import"./oitFragment-Bq4Z5Zet.js";import"./openpbrUboDeclaration-BnmviTIL.js";import"./pbrDebug-EJGf-rSa.js";import"./clipPlaneFragment-CsHSAKOD.js";import"./logDepthDeclaration-CkJKbonn.js";import"./fogFragment-Caa9md_2.js";import"./helperFunctions-aHUsQVqd.js";import"./harmonicsFunctions-BWmQr5Fd.js";import"./meshUboDeclaration-B9BH-mM5.js";import"./mainUVVaryingDeclaration-X84wF04a.js";const r="openpbrFragmentSamplersDeclaration",E=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=E);const n="openpbrNormalMapFragmentMainFunctions",S=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=S);const i="openpbrNormalMapFragmentFunctions",h=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=h);const t="openpbrDielectricReflectance",R=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=R);const o="openpbrConductorReflectance",N=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=N);const f="openpbrBlockAmbientOcclusion",A=`struct ambientOcclusionOutParams
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=A);const l="openpbrGeometryInfo",L=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=L);const c="openpbrIblFunctions",T=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=T);const s="openpbrNormalMapFragment",O=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=O);const m="openpbrBlockNormalFinal",F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=F);const d="openpbrBaseLayerData",b=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=b);const u="openpbrCoatLayerData",C=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=C);const p="openpbrThinFilmLayerData",M=`#ifdef THIN_FILM
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=M);const _="openpbrEnvironmentLighting",D=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=D);const g="openpbrDirectLightingInit",P=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=P);const v="openpbrDirectLighting",G=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=G);const a="openpbrPixelShader",I=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=I);const k={name:a,shader:I};export{k as openpbrPixelShaderWGSL};
