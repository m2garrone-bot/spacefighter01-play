import{c as e}from"./index-ghNTaqsY.js";import"./vertexColorMixing-kLUkjvOq.js";import"./openpbrUboDeclaration-BI7DJf3z.js";import"./mainUVVaryingDeclaration-BS5hG31t.js";import"./helperFunctions-aBwk4JN9.js";import"./harmonicsFunctions-Bt1URvmH.js";import"./logDepthVertex-BQ1f6qNS.js";import"./logDepthDeclaration-DoWOG8i_.js";import"./meshUboDeclaration-CclOk_1c.js";const n="openpbrVertexDeclaration",a=`uniform mat4 view;uniform mat4 viewProjection;uniform vec4 vEyePosition;
#ifdef MULTIVIEW
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=a);const o="openpbrNormalMapVertexDeclaration",E=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=E);const r="openpbrNormalMapVertex",_=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=t);const M={name:i,shader:t};export{M as openpbrVertexShader};
