import{c as e}from"./index-DfxcIkvT.js";import"./oitFragment-BfQo1urc.js";const i="bumpFragmentMainFunctions",f=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=f);const t="bumpFragmentFunctions",r=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=r);const a="bumpFragment",s=`var uvOffset: vec2f= vec2f(0.0,0.0);
