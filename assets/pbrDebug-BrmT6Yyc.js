import{c as e}from"./index-DfxcIkvT.js";import"./mainUVVaryingDeclaration-AIOR56Jm.js";import"./oitFragment-DpHCDYYp.js";const t="pbrFragmentExtraDeclaration",E=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=E);const o="subSurfaceScatteringFunctions",h=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=h);const i="importanceSampling",L=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=L);const a="pbrHelperFunctions",D=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=D);const n="pbrDirectLightingSetupFunctions",p=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=p);const r="pbrDirectLightingFalloffFunctions",A=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=A);const l="hdrFilteringFunctions",v=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=v);const f="pbrDirectLightingFunctions",S=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=S);const c="pbrIBLFunctions",m=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=m);const s="pbrBlockNormalGeometric",C=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=C);const d="pbrBlockImageProcessing",N=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=N);const g="pbrBlockPrePass",_=`#if SCENE_MRT_COUNT>0
